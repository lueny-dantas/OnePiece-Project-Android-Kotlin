    ...
    fun retrieveCharacters() =
        listOf(
            Character(
                ...
                "Akuma no Mi: Fruta da Borracha",
                "Poderes: Capacidades físicas sobre-humanas: além de velocidade, agilidade e reflexos aprimorados, Luffy tem uma força inacreditável, sendo capaz quebrar materiais resistentes como aço e concreto.\n" +
            ...
            Character(
                ...
                "Poderes: Ittoryu, Nitoryu e Santoryu: Zoro domina o Ittoryu (Estilo Uma Espada), o Nitoryu (Estilo Duas Espadas), e desenvolveu por conta própria o Santoryu (Estilo Três Espadas). Neste último, ele usa uma espada em cada mão enquanto leva outra na boca. Os três estilos são usados para ataques de alta velocidade e ataques de projeção de ar comprimido. O Santoryu permite que ele combine os dois tipos de ataques em uma mesma técnica.\n" +
            ...
            Character(
                image = R.drawable.usopp,
                "Usopp",
                "Função no Grupo: Atirador",
                "Akuma no Mi: Não Possui",
                "Poderes: Tiro: Usopp é um habilidoso atirador que usa sua incrível mira e seus conhecimento de engenharia para acertar alvos a grandes distâncias, seja com sua baladeira/estilingue, seja com canhões.\n" +
            ...
            Character(
                ...
                "Akuma no Mi:  Não Possui",
                "Poderes: Capacidades físicas sobre-humanas: seu treinamento lhe proporcionaram força, velocidade e resistência inacreditáveis Sanji pe capaz de destruir até mesmo metal apenas com sua força física.\n" +
            ...
            Character(
                ...
                "Akuma no Mi: Fruta Humano",
                "Poderes: Horn Point: provoca o crescimento de seus chifres.\n" +
            ...
            Character(
                ...
                "Akuma no Mi: Fruta da Flor",
                "Poderes: Clutch: com essa técnica, ela replica suas mãos nas costas do oponente e as usa para atacá-lo sem que ela possa revidar.\n" +
            ...
            Character(
                image = R.drawable.franky,
                "Franky",
                "Função no Grupo: Carpinteiro",
                "Akuma no Mi: Não Possui",
                "Poderes: Força sobre-humana: mesmo quando perigosamente ferido, Franky ainda se destaca como um dos integrantes mais fortes da tripulação.\n" +
            ...
            Character(
                ...
                "Akuma no Mi: Fruta Revivi",
                "Poderes: Música: além de entreter com sua arte, Brook é capaz de usar sua música para influenciar as pessoas, e até fazer os oponentes adormecerem. Ele consegue tocar qualquer instrumento.\n" +
